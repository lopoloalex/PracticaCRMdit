...
typealias TargetType = [String:Any]
...
class TargetTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        if let targets = visit?["Targets"] as? [TargetType]{
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let company = target["Company"] as? [String:Any]{
        let name = company["name"] as? String
        cell.textLabel?.text=name
        }
        if let targetType = target["TargetType"] as? [String:Any],
            let name = targetType["name"] as? String{
